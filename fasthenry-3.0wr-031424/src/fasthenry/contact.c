...
void set_edge_nodes(G_nodes*, G_nodes*, int, int, int, Gcell*);
void find_or_make_node(Gcell*, Gcell*, Gcell*, int, int, double, double,
    Nonuni_gp*);
void fix_adjacency(G_nodes*, int, G_nodes*, G_nodes*);
G_nodes *find_mid_node(G_nodes*, int, G_nodes*);
...
void set_edge_nodes(G_nodes *node1, G_nodes *node2, int adj_dir,
    int dir1, int dir2, Gcell *cell)
{
  G_nodes *node;
...
void find_or_make_node(Gcell *cell, Gcell *kid1, Gcell *kid2,
    int node_start, int node_end, double x, double y, Nonuni_gp *gp)
{
  char adj_dir;
  G_nodes *node;
...
void fix_adjacency(G_nodes *begin_node, int adj_dir, G_nodes *node,
    G_nodes *end_node)
{
...
G_nodes *find_mid_node(G_nodes *begin_node, int adj_dir, G_nodes *end_node)
{
  G_nodes *node;
  double x,y;
